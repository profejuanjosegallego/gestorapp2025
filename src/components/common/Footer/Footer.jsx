                ...
                <div className='footer__contact-info'>
                    ...
                    <div className='footer__social-icons'>
                        <div className='footer__social-icon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="footer__icon --icon-facebook" viewBox="0 0 16 16">
                        ...
                        <div className='footer__social-icon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="footer__icon bi bi-instagram" viewBox="0 0 16 16">
